...
class SynsetDistance(Comparator):
    ...
    def compare(self, statement, other_statement):
        ...
        tokens1 = remove_stopwords(tokens1, language='english')
        tokens2 = remove_stopwords(tokens2, language='english')
...
print(levenshtein_distance.compare(statement='此时文字测试什么' , other_statement='此时文字测试什'))
# print(jaccard_similarity.compare(statement='aaaaaaaaaa' , other_statement='aaaaaaaaaa'))
